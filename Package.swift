...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.1/GhosttyKit.xcframework.zip",
            checksum: "bb19514758a60923400958cc489d1e9eb1abb0ac958c6972f1c29490ab4ead08"
        ),
        .testTarget(
            name: "GhosttyKitTest",
