...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.4/GhosttyKit.xcframework.zip",
            checksum: "231ac286802fd6474df19745ecf2b6c20d21b809a1b7e21cf001c9f7dc3b968e"
        ),
        .testTarget(
            name: "GhosttyKitTest",
