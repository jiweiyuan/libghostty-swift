...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.0/GhosttyKit.xcframework.zip",
            checksum: "91e4f3db545f4bf4de163924eb09d2216833b1191ddfce06a9deb6783e4eddf3"
        ),
        .testTarget(
            name: "GhosttyKitTest",
