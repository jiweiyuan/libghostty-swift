...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.0.17/GhosttyKit.xcframework.zip",
            checksum: "49cb982ecd822c13aa6d3d57e349f0a0c504f1c33c191a7d13fd545d8e2c36b3"
        ),
        .testTarget(
            name: "GhosttyKitTest",
