...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.13/GhosttyKit.xcframework.zip",
            checksum: "8eb480fead522c965ec846eada73b3ff6b09d599cc0661f847131de152beec89"
        ),
        .testTarget(
            name: "GhosttyKitTest",
