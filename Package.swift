...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/termio-sh/libghostty-swift/releases/download/storage.1.0.18/GhosttyKit.xcframework.zip",
            checksum: "4f662b40aab39fc0b08f1571d632b25fbbe953c3fb6b4a2fbd67d5d8e335fbe8"
        ),
        .testTarget(
            name: "GhosttyKitTest",
