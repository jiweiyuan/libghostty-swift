...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.8/GhosttyKit.xcframework.zip",
            checksum: "d4115c4e6e88873f395fd7b621c4ebece251909a24d5837e433720f07c2dbdf6"
        ),
        .testTarget(
            name: "GhosttyKitTest",
