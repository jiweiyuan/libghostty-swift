...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/jiweiyuan/libghostty-swift/releases/download/storage.1.0.16/GhosttyKit.xcframework.zip",
            checksum: "c57d903cf8ce4af9eae0edd0d0fdf5079a8af77b9f66345b557796d2f189ac9d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
